...
logging.getLogger("shipping").addHandler(_handler)
logging.getLogger("shipping").setLevel(logging.INFO)
...
app = FastAPI(
    ...
    version="1.0.0",
    lifespan=lifespan,
    description="Manages shipment lifecycle from PENDING to DELIVERED.",
)
