...
logging.getLogger("payment").addHandler(_handler)
logging.getLogger("payment").setLevel(logging.INFO)
...
app = FastAPI(
    ...
    version="1.0.0",
    lifespan=lifespan,
    description="Handles charges, refunds, and idempotent payment processing.",
)
